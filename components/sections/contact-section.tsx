        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:primtraisorat@gmail.com"
              ...
              >
                {[
                  { label: "LinkedIn", href: "https://www.linkedin.com/in/primtraisorat" },
                  { label: "Instagram", href: "https://www.instagram.com/taeytraisorat" },
                ].map((social) => (
                  <a
                    key={social.label}
                    href={social.href}
